...
4. Comience a agregar estilos en la parte superior de la página y continúe hacia abajo. Solo pase a la siguiente sección una vez que esté satisfecho de haber completado el área en la que está trabajando.

## Envío de su solución

Envíe su solución en el google forms adjunto en el canal de discord, puede agregar sus repositorios externos de GitHub y GitHub Pages o adjuntar un archivo ZIP.
El formulario se cerrará el Domingo 18/07 a las 23hs Argentina.
